...
const DynamicBorderAnimationsCard = () => {
  ...
  return (
    <div className="relative w-full max-w-2xl bg-gray-900 dark:bg-slate-900 border border-gray-800 dark:border-slate-700 rounded-2xl p-8 md:p-12 overflow-hidden shadow-2xl">
      ...
      <div className="relative z-10 text-center">
        <h1 className="text-3xl md:text-4xl font-bold mb-6">
          <span className="text-white dark:text-white">Dynamic Border</span>{' '}
          <span className="bg-gradient-to-r from-orange-400 to-purple-500 text-transparent bg-clip-text">
            Animations
          </span>
        </h1>
        
        <p className="text-gray-400 dark:text-slate-300 max-w-xl mx-auto mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((item) => (
            <div 
              key={item}
              className="bg-gray-800/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700 dark:border-slate-600 hover:border-orange-500/30 dark:hover:border-orange-500/30 transition-all"
            >
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-orange-500/20 to-purple-500/20 flex items-center justify-center mr-3">
                  <span className="text-orange-400 font-semibold">{item}</span>
                </div>
                <div>
                  <h3 className="font-medium text-white dark:text-white">Feature {item}</h3>
                  <p className="text-sm text-gray-400 dark:text-slate-400">Description of feature</p>
                </div>
              </div>
            </div>
          ))}
...
export default DynamicBorderAnimationsCard;