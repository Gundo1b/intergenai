...
function PricingCard({ title, desc, price, options, featured = false, showArrow = false }: PricingCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`relative bg-gradient-to-br from-[#F9FBFF]/95 to-white/90 dark:from-gray-900/95 dark:to-gray-800/90 backdrop-blur-sm border rounded-2xl p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-sky-400/20 hover:border-sky-300/70 group ${featured
    ...
    >
      ...
      <button className={`w-full py-4 px-6 rounded-xl font-semibold transition-all duration-300 border-2 relative z-10 ${featured
    ...
    <section className="py-16 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light text-gray-900 dark:text-white mb-6">
            Simple, transparent{' '}
