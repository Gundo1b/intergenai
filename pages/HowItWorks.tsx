          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {modes.map((mode, index) => (
                ...
                >
                  <div className={`relative p-8 rounded-3xl bg-white/70 dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-md hover:bg-white/80 dark:hover:bg-white/10 transition-all duration-300 ${mode.glow} hover:shadow-2xl`}>
                    ...
                    <div className="relative text-center">
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300">{mode.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <div className="relative bg-white/70 dark:bg-white/10 backdrop-blur-md border border-slate-200 dark:border-white/20 rounded-3xl p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-slate-600 dark:text-slate-300 text-sm font-mono">Integen Studio</span>
                  </div>
                  
                  <div className="bg-black/30 dark:bg-black/30 rounded-2xl p-6 border border-white/10 dark:border-white/10">
                    <div className="flex items-center gap-3 mb-4">
                      <Upload size={20} className="text-brand-start" />
                      <span className="text-slate-600 dark:text-slate-300 text-sm">Upload files or type your prompt...</span>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {examples.map((example, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true, amount: 0.2 }}
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    className="bg-white/70 dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 rounded-2xl p-6 hover:bg-white/80 dark:hover:bg-white/10 transition-all duration-300"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {resultTypes.map((result, index) => (
                ...
                >
                  ...
                  <div className="relative bg-white/70 dark:bg-white/5 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-3xl p-8 hover:bg-white/80 dark:hover:bg-white/10 transition-all duration-300">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-3">{result.title}</h3>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
              {refinementTools.map((tool, index) => (
                <motion.div
                  ...
                  className="group bg-white/70 dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 rounded-2xl p-6 hover:bg-white/80 dark:hover:bg-white/10 transition-all duration-300 text-center"
                >
                  ...
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2">{tool.title}</h4>
            ...
            >
              <div className="inline-flex items-center gap-4 px-8 py-4 bg-gradient-to-r from-brand-start/20 to-brand-end/20 border border-brand-start/30 rounded-full backdrop-blur-sm">
                ...
                <span className="text-slate-900 dark:text-white font-semibold">Export in your preferred format</span>
          ...
          >
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="px-8 py-4 rounded-full border border-slate-300 dark:border-white/20 text-slate-700 dark:text-white font-semibold text-lg hover:bg-slate-50 dark:hover:bg-white/10 transition-all duration-300">
                  Watch Demo
                </button>
              </div>
            </div>
