...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      {/* Static Background simplified: subtle grid only */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 opacity-10 bg-gradient-to-br from-[#64E1FF]/20 to-[#009DFF]/20" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 relative">
        <div className="max-w-6xl mx-auto relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              {values.map((value, index) => (
                ...
                >
                  ...
                  {[...Array(3)].map((_, i) => (
                    <motion.div
                      key={i}
                      className="absolute w-1 h-1 bg-[#64E1FF] rounded-full opacity-0 group-hover:opacity-100"
                      style={{
                        left: `${20 + i * 30}%`,
                        top: `${30 + i * 10}%`,
                      }}
